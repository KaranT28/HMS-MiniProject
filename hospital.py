...
class Hospital:
     def __init__(self, root):
        ...
        # _______________ DATA FRAME _______________________
        ...
        #______________Buttons Frame _______________________

        Buttonframe=Frame(self.root, bd=20, relief=RIDGE)
        Buttonframe.place(x=0, y=530, width=1530, height=70)

        #_____________ Details _____________________
        Detailsframe=Frame(self.root, bd=20, relief=RIDGE)
        Detailsframe.place(x=0, y=600, width=1530, height=190)

        # ________________Data Frame Left __________________

        lblNameTablet = Label(DataframeLeft, text="Name of Tablet", font=("times new roman", 12, "bold"), padx=2, pady=6)
        lblNameTablet.grid(row=0, column=0)

        comNametablet=ttk.Combobox(DataframeLeft, textvariable=self.Nameoftablet, font=("times new roman", 12, "bold"),
                                    width=37)
        comNametablet["values"]=("Dolo650", "Corona Vaccine", "Acetaminophen", "Adderall", "Amlodipine", "Ativan")
        ...
        lblNoOftablet=Label(DataframeLeft, font=("arial", 12, "bold"), text="No Of Tablets:", padx=2, pady=2)
        ...
        #_______________ DataFrame Right_______________________________________________
        ...
        btnPrescription=Button(Buttonframe, command=self.iPrescription, text="Prescription",bg="green", fg="white", font=("arial", 12, "bold"), width=23, height=0, padx=2, pady=6)
        btnPrescription.grid(row=0, column=0)

        btnPrescriptionData=Button(Buttonframe,command=self.iPrescriptionData, text="Prescription Data",bg="green", fg="white", font=("arial", 12, "bold"), width=23, height=0, padx=2, pady=6)
        btnPrescriptionData.grid(row=0, column=1)

        btnUpdate=Button(Buttonframe, command=self.update_data, text="Update",bg="green", fg="white", font=("arial", 12, "bold"), width=23, height=0, padx=2, pady=6)
        btnUpdate.grid(row=0, column=2)

        btnDelete=Button(Buttonframe, command=self.idelete, text="Delete",bg="green", fg="white", font=("arial", 12, "bold"), width=23, height=0, padx=2, pady=6)
        btnDelete.grid(row=0, column=3)

        btnClear=Button(Buttonframe, command=self.clear, text="Clear",bg="green", fg="white", font=("arial", 12, "bold"), width=23, height=0, padx=2, pady=6)
        btnClear.grid(row=0, column=4)

        btnExit=Button(Buttonframe, command=self.iExit, text="Exit",bg="green", fg="white", font=("arial", 12, "bold"), width=23, height=0, padx=2, pady=6)
        btnExit.grid(row=0, column=5)



        # ___________________________TABLE______________________________________        
        #____________________________ Scroll Bar______________________________________
        scroll_x=ttk.Scrollbar(Detailsframe, orient=HORIZONTAL)
        scroll_y=ttk.Scrollbar(Detailsframe, orient=VERTICAL)

        self.hospital_table=ttk.Treeview(Detailsframe, columns=("nameoftablet", "ref", "dose", "nooftablets", 
                                                                "lot", "issuedate", "expdate", "dailydose", "storage", "nhsnumber", "pname", 
        ...
        #_____________________________________functionality declaration_____________________
     def iPrescriptionData(self):
        if self.Nameoftablet.get()=="" or self.ref.get()=="":
                messagebox.showerror("Error", "All fields are required")
        else:
             conn=mysql.connector.connect(host="localhost", user="root", password="root", database="HMSData",auth_plugin='mysql_native_password')
             ...
             self.fetch_data
             conn.close()
             messagebox.showinfo("Done!","Record has been inserted.")
